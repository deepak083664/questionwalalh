      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 font-medium text-sm">
          {papers.map((paper) => (
            <div
              key={paper._id}
              className="bg-white border border-slate-200/50 rounded-2xl p-5 shadow-premium hover:shadow-card hover:border-slate-300 transition-all duration-200 flex flex-col justify-between"
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex gap-2">
                    <span className="px-2 py-0.5 bg-indigo-50 text-[9px] font-bold text-indigo-600 rounded">
                      Class {paper.class}
                    </span>
                ...
                <div className="grid grid-cols-2 gap-2 pt-2.5 text-xs font-bold text-slate-500 border-t border-slate-50">
              ...
              <div className="flex items-center gap-2 mt-4 pt-3.5 border-t border-slate-100">
                <button
                  ...
                  className="flex-1 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-650 font-bold rounded-xl text-xs flex items-center justify-center gap-1 transition-all"
                >
                ...
                <button
                  ...
                  className="p-2 text-slate-450 hover:text-emerald-600 hover:bg-slate-50 rounded-xl transition-all"
                  title="Download PDF"
                >
